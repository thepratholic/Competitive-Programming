...
def solve():
    b_b, b_a = map(int, sys.stdin.readline().split())
    s_b, s_a = map(int, sys.stdin.readline().split())
    g_b, g_a = map(int, sys.stdin.readline().split())
    p_b, p_a = map(int, sys.stdin.readline().split())

    gold_to_platinum   = p_a - p_b # 1
    silver_to_gold     = (g_a - g_b) + gold_to_platinum # 1
    bronze_to_silver   = (s_a - s_b) + silver_to_gold # 1
